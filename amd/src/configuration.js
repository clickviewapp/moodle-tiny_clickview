...
/**
 * Tiny ClickView Video configuration.
 *
 * @module      tiny_clickview/configuration
...
export const configure = (instanceConfig) => {
    // Update the instance configuration to add the ClickView Video menu option to the menus and toolbars.
    return {
